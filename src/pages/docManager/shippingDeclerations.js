              ...
              >
                ...
                >
                      ...
                      <TableRow>
                        ...
                        >
                          ...
                          <strong className="underline">
                            {selectedShipDec.consigne}
                          </strong>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell sx={{ width: "100%" }}>
                          {selectedShipDec.transportType}
                        </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
                  ...
                  >
                    ...
                    <TableBody>
                      {selectedShipDec.containerNumbers.map(
                        (container, index) => {
                          return (
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <strong>
                                  {selectedShipDec.sealNumbers[index]}
                                </strong>
                              </TableCell>
                              <TableCell>
                                <strong>
                                  {selectedShipDec.wagonNumbers[index]}
                                </strong>
                              </TableCell>
                            </TableRow>
                          );
