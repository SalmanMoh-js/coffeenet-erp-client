...
import { getPendingAccs } from '../../actions/adminActions';

function PendingAccountsContainer() {
  ...
  return (
    <Grid className='dashboard-container'>
      <AccountsList admin={admin} type='pending' />
    </Grid>
  );
}

export default PendingAccountsContainer;
